        ...
        <section className="py-24 relative overflow-hidden bg-gradient-to-br from-[#18181b] via-[#23272f] to-[#0f172a]">
            <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1 flex flex-col items-start justify-center">
                    ...
                    >
                        Experience seamless, secure, and rewarding buying &
                        selling. Join AsyncAwait Auction and discover a smarter
                        way to win.
                    </motion.p>
                        ...
                        {BENEFITS.map((b, i) => (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="text-white/80 text-base leading-tight">
                                        {b.desc}
                                    </div>
                                </div>
                            </motion.div>
                    ...
                    <Link href="/signup">
                        <Button
                            size="lg"
                            className="bg-gradient-to-r from-orange-500 to-pink-600 hover:from-orange-600 hover:to-pink-700 text-white px-8 py-4 text-lg rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-orange-500/25 flex items-center gap-2"
                        >
                ...
                >
                    ...
                    <svg
                        ...
                        className="w-[260px] md:w-[340px] h-auto drop-shadow-2xl"
                    >
                        <circle
                            cx="170"
                            cy="170"
