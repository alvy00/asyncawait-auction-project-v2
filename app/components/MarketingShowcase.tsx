    ...
    return (
      ...
      /> */}
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
                ...
                >
                    Lightning-fast bidding, real-time excitement, and unbeatable
                    deals. Our next-gen auction platform brings together rare
                    finds, passionate communities, and stunning live events—all
                    in one seamless, secure, and beautiful interface.
                </motion.p>
                <motion.div
                ...
                >
                    <Link href="/auctions/live">
                        <Button
                            size="lg"
                            className="rounded-full bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-500 hover:to-blue-600 text-white px-8 py-3 text-lg shadow-lg"
                        >
                    ...
                    <Link href="/signup">
                        <Button
                            size="lg"
                            variant="outline"
                            className="rounded-full border-cyan-400 text-cyan-200 bg-cyan-900/10 hover:bg-cyan-900/20 hover:text-white px-8 py-3 text-lg"
                        >
                            Join the Action
                        </Button>
                    </Link>
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-lg font-bold text-cyan-100 mb-1">
                            Real-Time Bidding
                        </span>
                        <span className="text-white/80 text-base">
                            Bid live with instant updates and zero lag. Never
                    ...
                    <motion.div
                        ...
                        transition={{ type: "spring", stiffness: 200 }}
                    >
                        <span className="text-3xl mb-2 text-orange-300">
                            🎁
                        </span>
                        <span className="text-lg font-bold text-orange-100 mb-1">
                            Exclusive Finds
                        </span>
                        <span className="text-white/80 text-base">
                            Access rare items, collectibles, and flash deals you
                    ...
                    <motion.div
                        ...
                        transition={{ type: "spring", stiffness: 200 }}
                    >
                        <span className="text-3xl mb-2 text-purple-300">
                            🔒
                        </span>
                        <span className="text-lg font-bold text-purple-100 mb-1">
                            Secure & Trusted
                        </span>
                        <span className="text-white/80 text-base">
                            Your privacy and security are our top priority. Bid
                            with confidence, always.
                        </span>
                    </motion.div>
                </motion.div>
            </div>
