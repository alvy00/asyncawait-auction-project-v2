    ...
    const values = [
        {
            ...
            description:
                "We prioritize the security of every transaction with advanced encryption and fraud protection.",
        },
        {
            icon: <Heart className="w-8 h-8" />,
            title: "User-Centric",
            description:
                "Every feature is designed with our users in mind, ensuring the best possible auction experience.",
        },
        {
            icon: <Zap className="w-8 h-8" />,
            title: "Innovation",
            description:
                "We continuously innovate to bring cutting-edge auction technology to our platform.",
        },
        {
            icon: <Globe className="w-8 h-8" />,
            title: "Global Reach",
            description:
                "Connecting bidders and sellers worldwide through our seamless auction platform.",
        },
    ];
    ...
    const team = [
        {
            ...
            description:
                "Visionary leader with 15+ years in fintech and e-commerce.",
        },
        {
            name: "Michael Chen",
            role: "CTO",
            ...
            description:
                "Tech innovator specializing in blockchain and auction systems.",
        },
        {
            ...
            <section className="relative pt-32 pb-20 px-4 overflow-hidden">
                ...
                <div className="container mx-auto max-w-6xl relative z-10">
                    <motion.div className="text-center mb-16" {...fadeInUp}>
                        ...
                        >
                            Revolutionizing the auction experience through
                            cutting-edge technology, transparent processes, and
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-300 leading-relaxed">
                                To democratize the auction process by providing
                                a secure, transparent, and user-friendly
                                platform that connects buyers and sellers
                                globally. We believe everyone should have access
                                to fair and exciting auction experiences.
                            </p>
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-300 leading-relaxed">
                                To become the world's most trusted auction
                                platform, setting new standards for innovation,
                                security, and user experience. We envision a
                                future where auctions are accessible,
                ...
                <div className="container mx-auto max-w-4xl text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                            Experience the future of auctions with AuctaSync.
