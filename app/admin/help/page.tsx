...
const HELP_CATEGORIES = [
    {
        ...
        icon: <FaBook className="text-blue-400" size={24} />,
        articles: 12,
    },
    {
        id: 2,
        title: "Account Management",
        icon: <FaHeadset className="text-purple-400" size={24} />,
        articles: 8,
    },
    {
        id: 3,
        title: "Auction Process",
        icon: <FaQuestionCircle className="text-green-400" size={24} />,
        articles: 15,
    },
    {
        id: 4,
        title: "Payments & Billing",
        icon: <FaHeadset className="text-amber-400" size={24} />,
        articles: 10,
    },
    {
        id: 5,
        title: "Security & Privacy",
        icon: <FaBook className="text-red-400" size={24} />,
        articles: 7,
    },
    {
        id: 6,
        title: "Video Tutorials",
        icon: <FaVideo className="text-teal-400" size={24} />,
        articles: 5,
    },
];
...
const POPULAR_ARTICLES = [
    {
        id: 1,
        title: "How to create a new auction",
    ...
    {
        id: 3,
        title: "Understanding bid verification process",
